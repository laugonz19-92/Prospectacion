...
export const SAMPLE_DATASETS: SampleDataset[] = [
  {
    id: 'pos-inventario-tienda',
    name: '🏪 Inventario POS Tienda EAN 2026',
    description: 'Inventario de tienda con SKUs, Códigos de Barras, IVA, Proveedores, Precios y Stock.',
    csvText: `SKU,CodigoBarras,Producto,Categoria,PrecioUnitario,PrecioCosto,ImpuestoIVA,Stock,UnidadMedida,Proveedor,Estado
